...
class Bankamatik():
    ...
    def hesapBilgisiAlma(self, hesapNumarasi=False):
        ...
        vti = main_veri.main_veri()  # type: ignore
    ...
    def anaPencereEkrani(self):
        ...
        self.anaPencere.geometry("1000x1000+200+200")
    ...
    def ortakPencereKisimlari(self, baslik, boyutlar, agacYukseklik=100, agacGenislik=186, butonFont="Times 14", butonGenislik=26):
    ...
    def paraCek(self):
        ...
        hesapId, hesaptakiTutar, hesapTuru, hesapNumarasi = self.hesapBilgisiAlma(self.__nesneler[0].get())  # type: ignore
    ...
    def paraTransfer(self):
        ...
        ## GÖNDERECEK HESAP #############################################
        hesapId1, hesaptakiTutar1, hesapTuru1, hesapNumarasi1 = self.hesapBilgisiAlma(self.__nesneler[0].get())  # type: ignore
        #################################################################
        ...
        if self.var.get() == 1:#radioButton1 aktifse yani "Kendi Hesabıma Yatır" işlemi yapılacaksa
            ...
            hesapId2, hesaptakiTutar2, hesapTuru2, hesapNumarasi2 = self.hesapBilgisiAlma(self.__nesneler[4].get())  # type: ignore
...
".format(girilenTutar, hesapTuru1, hesapTuru1, oran, hesapTuru2, int(girilenTutar)*oran, hesapTuru2, int(girilenTutar)*oran, hesapTuru2,round(int(girilenTutar)*oran),hesapTuru2))
    ...
    def hesapSil(self):
        hesapId, hesaptakiTutar, hesapTuru, hesapNumarasi = self.hesapBilgisiAlma(self.__nesneler[0].get())# type: ignore #self.__nesneler[0].get()==comboHesapNo bulunuyor.
